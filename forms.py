...
class VolunteerForm(FlaskForm):
    ...
    event = SelectField("Select which event you attended",
                 choices=[('WISE', 'WISE'),('WISE Prep Work(LEADS ONLY)', 'WISE Prep Work(LEADS ONLY)') ,('WISTEM2D', 'WISTEM2D'), ('WISTEM2D Prep Work(LEADS ONLY)', 'WISTEM2D Prep Work(LEADS ONLY)'),('Food Drive', 'Food Drive'),('Food Drive Prep Work(LEADS ONLY)', 'Food Drive Prep Work(LEADS ONLY)'),('ARIS STEM Summit','ARIS STEM Summit'), ('ARIS STEM Summit Prep Work(LEADS ONLY)', 'ARIS STEM Summit Prep Work(LEADS ONLY)'),('Charity Miles','Charity Miles'), ('Charity Miles Prep Work(LEADS ONLY)', 'Charity Miles Prep Work(LEADS ONLY)'),('Animal Shelter','Animal Shelter'),('Animal Shelter Prep Work(LEADS ONLY)','Animal Sheler Prep Work(LEADS ONLY)'), ('FLL BoroBlast', 'FLL BoroBlast'),('FLL BoroBlast Prep Work(LEADS ONLY)', 'FLL BoroBlast Prep Work(LEADS ONLY)'), ('IBM', 'IBM'), ('IBM Prep Work(LEADS ONLY)', 'IBM Prep Work(LEADS ONLY)')])
